...
var SearchHelper = (function () {
    ...
    SearchHelper.prototype.findPrevious = function (term) {
        ...
        if (!result) {
            for (var y = this._terminal.ybase + this._terminal.rows - 1; y > startRow; y--) {
                result = this._findInLine(term, y);
                if (result) {
                    break;
                }
    ...
    SearchHelper.prototype._findInLine = function (term, y) {
        var bufferLine = this._terminal.lines.get(y);
        var lowerStringLine = BufferLine_1.translateBufferLineToString(bufferLine, true).toLowerCase();
