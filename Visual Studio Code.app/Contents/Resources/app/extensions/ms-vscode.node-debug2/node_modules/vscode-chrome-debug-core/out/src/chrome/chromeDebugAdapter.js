...
class ChromeDebugAdapter {
    constructor({ chromeConnection, lineColTransformer, sourceMapTransformer, pathTransformer, targetFilter }, session) {
        ...
        this._scriptEventsBeforeInitializedEventFired = [];
    ...
    doAttach(port, targetUrl, address, timeout, websocketUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            // Client is attaching - if not attached to the chrome target, create a connection and attach
            this._clientAttached = true;
            if (!this._chromeConnection.isAttached) {
                if (websocketUrl) {
                    yield this._chromeConnection.attachToWebsocketUrl(websocketUrl);
                }
                else {
                    yield this._chromeConnection.attach(address, port, targetUrl, timeout);
                }
                this._port = port;
    ...
    sendScriptEventsBeforeInitializedEventFired() {
    ...
    onScriptParsed(script) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const scriptEvent = this.scriptToScriptEvent(script);
