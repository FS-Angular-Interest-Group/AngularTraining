			...
			<div class="navbg">
				<div class="col960">
					<ul id="navul" class="cl">
						<li><a
							href="<%=request.getContextPath()%>/page/adminPage.jsp"
						...
						<marquee height="100px" scrollAmount=3 direction=up
							...
							<img src="image/lb.png" width=15 height=15 /><a
								...
								target='_blank'>中国初级创伤救治培训基地<img src=image/hot.gif width=25
									height=13 border=0>
							</a> </span> <br> <img src="image/lb.png" width=15 height=15 /><a
				...
				<div id="sidebar1" class="sidebar";">
					...
					<marquee height="120px" scrollAmount=3 direction=up
						...
						<img src="image/555.jpg" width=15 height=15 /><a
							...
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-30）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-29）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-28）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-27）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-26）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-25）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-24）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-23）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-22）</a>
						</span> <br> <img src="image/555.jpg" width=15 height=15 /><a
							href='http://www.qkankan.com/zt/shijie500qiang/'
							onmousedown="return AdsClick(3152,37989)" target='_blank'
							style="color: #2858c8;">蓝天医院</a> <span> <a href='#'
							onmousedown="return AdsClick(3152,37989)" target='_blank'>门诊出诊医师临时变更公告（5-21）</a>
						</span> <br>
					</marquee>
					<br> <br> <br>
				</div>
